...
Arena = function(game) {
    ...
    materialGround.diffuseTexture = new BABYLON.Texture("static/images/tile.jpg", scene);
    ...
    materialWall.diffuseTexture = new BABYLON.Texture("static/images/tile.jpg", scene);
